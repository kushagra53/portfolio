...
import ParallaxVault from "@/components/ui/ParallaxVault";
  ...
  const projects = [
    {
      ...
      link: "https://github.com/kushagra53/network-traffic-anomaly-detector",
    ...
    },
    {
      ...
      link: "https://github.com/kushagra53/AgriAdvisor",
      status: "DEPLOYED" as const
    },
    {
      id: "003",
      ...
      link: "https://github.com/convolutionnal/landmark-recognition-using-dl",
    ...
    },
    {
      ...
      link: "https://github.com/kushagra53/aws-terraform-devsecops-tfsec-demo",
      status: "DEPLOYED" as const
    }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center relative px-6 text-center overflow-hidden">
        ...
        {/* Text Overlay */}
        <div className="z-10 max-w-4xl relative pointer-events-none">
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-6 tracking-tight text-[#e6f1ff]">
            Hello World. I am <span className="text-[#64ffda]">Kushagra Pandey</span>.
          </h1>
          <div className="text-3xl md:text-5xl text-[#8892b0] font-mono mb-16 h-20">
      ...
      <section id="projects" className="w-full">
        ...
        {/* 3D Parallax Scroll */}
        <ParallaxVault projects={projects} />
        ...
        <div className="flex flex-col md:flex-row gap-16 items-start">
          ...
          <div className="w-full md:w-[60%]">
            ...
            <div className="bg-[#0a0f14] border-x border-b border-[#333] p-6 font-mono text-base leading-relaxed text-[#c5c8c6] rounded-b-lg h-full min-h-[450px] overflow-y-auto custom-scrollbar">
              <div className="mb-6">
                <p className="text-[#8892b0] italic mb-2">// 3rd-Year CSE Student @ JUET</p>
      ...
      <section id="contact" className="w-full bg-[#0d1f3a] py-32 border-t border-[#112240]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="flex items-center gap-4 mb-16">
            ...
            <h2 className="text-3xl font-bold text-[#e6f1ff]">Encrypted Comms</h2>
            <div className="h-[1px] bg-[#233554] flex-grow ml-4"></div>
          </div>

          {/* Center-aligned body content */}
